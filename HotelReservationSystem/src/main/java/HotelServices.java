...
public class HotelServices {
     ...
     */
    public void findCheapestHotel(LocalDate[] dates) throws CustomHotelReservationException {
        if (hotelList.isEmpty()) {
            ...
            if (type.equalsIgnoreCase("Regular")) {
                ...
                throw new CustomHotelReservationException("Enter correct customer type",
                                                           CustomHotelReservationException.ExceptionType.ENTERED_CUSTOMER);
            }
        }
    }
     ...
     * throws custom exception if given date format is wrong
     * @return - returning array of dates that are booked
     */
    public LocalDate[] getBookingDates() throws CustomHotelReservationException {
        try {
            ...
            throw new CustomHotelReservationException("Enter correct date format", CustomHotelReservationException.ExceptionType.ENTERED_DATE);
        }
        return bookingDates;
    }
     ...
     */
    public void findCheapestHotelByRatings() throws CustomHotelReservationException {
     ...
     * by ratings, printing hotel name and rate for regular or reward type customers
     */
    public void findBestRatedHotel() throws CustomHotelReservationException {
        List<Hotel> sortedHotelList;
